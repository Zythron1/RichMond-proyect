...
/**
    ...
    * 
    * Esta clase gestiona las rutas relacionadas con los restablecimientos de contraseña para la API.
    * Define las rutas GET, POST, PUT y DELETE para acceder a la información de los restablecimientos de contraseña.
*/
class PasswordResetRouter {
    /**
