...
/**
    * Class UserRouter
    * 
    * Esta clase gestiona las rutas relacionadas con los usuarios para la API.
    * Define las rutas GET, POST, PUT y DELETE para acceder a la información de los usuarios.
*/
class UserRouter {
    /**
