...
/**
    ...
    * 
    * Esta clase gestiona las rutas relacionadas con los métodos de pago para la API.
    * Define las rutas GET, POST, PUT y DELETE para acceder a la información de los métodos de pago.
*/
class PaymentMethodRouter {
    /**
